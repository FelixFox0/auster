...
<?php if($product_type==2){ ?>
      ...
      <?php } ?>
        ...
        <div class="price-new"><?php echo $text_special_price; ?><span class="amount contrast_font" itemprop="price"><i class="ic-bage"></i><?php echo $special; ?></span></div>
        <div class="price-old"><?php echo $text_old_price; ?><span class="amount contrast_font"><i class="ic-bage"></i><?php echo $price; ?></span></div>
        <div class="price-save"><?php echo $text_you_save; ?><span class="amount contrast_font"><i class="ic-bage"></i><?php echo $yousave; ?></span> </div>
        </div>
