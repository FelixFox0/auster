  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="margin-b">
        ...
        <tbody>
          <tr>
            <td class="text-left" style="width: 50%;"><?php echo $text_return_id; ?> #<?php echo $return_id; ?><br />
              <?php echo $text_date_added; ?> <?php echo $date_added; ?></td>
            <td class="text-left" style="width: 50%;"><?php echo $text_order_id; ?> #<?php echo $order_id; ?><br />
              <?php echo $text_date_ordered; ?> <?php echo $date_ordered; ?></td>
          </tr>
        </tbody>
      </table>
      
      <div class="box-heading"><?php echo $text_product; ?></div>
      <table class="margin-b">
        <thead class="contrast_font">
          <tr>
      ...
      <table class="margin-b">
        <thead class="contrast_font">
          <tr>
            ...
            <td class="text-right" style="width: 33.3%;"><?php echo $column_action; ?></td>
          </tr>
        </thead>
        <tbody>
          <tr>
