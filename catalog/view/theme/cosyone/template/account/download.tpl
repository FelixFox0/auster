      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right"><a href="<?php echo $download['href']; ?>" data-tooltip="<?php echo $button_download; ?>" title="<?php echo $button_download; ?>" class="sq_icon"><i class="fa fa-cloud-download"></i></a></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
