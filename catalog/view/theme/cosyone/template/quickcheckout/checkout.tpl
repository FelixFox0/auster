...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="social_login_content_holder"></div>
	  ...
	  <link rel="stylesheet" media="screen" href="<?php echo $mobile_stylesheet; ?>" />
	  <?php } else { ?>
  ...
  <div class="quickcheckoutmid collapse" id="login-box">
    <div id="checkout">
	  ...
	  <div class="checkout-column">
		...
		<?php } else { ?>
		<div id="payment-address">
		  <div class="quickcheckout-heading box-heading"><span><?php echo $text_checkout_payment_address; ?></span></div>
		  <div class="quickcheckout-content"></div>
		</div>
		<?php } ?>
...
$(document).ready(function() {
	$.ajax({
		...
		cache: false,
		beforeSend: function() {
			$('#terms .quickcheckout-content').html('<div class="text-center"><i class="fa fa-spinner fa-spin fa-5x"></i></div>');
		},
		success: function(html) {
